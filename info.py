...
BOT_TOKEN = environ.get('BOT_TOKEN', "5705061532:AAGy_19JQIdXubEiazqahcgmXGSsJKE5W-s")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1740849725').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002238905048') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001819673133') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002209177912') # request channel id ( make sure bot is admin )
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/just_resqust')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/the_originalss')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/the_film_factory1')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ: Tct owner')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002497597012')) #Log channel id ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002497597012'))
